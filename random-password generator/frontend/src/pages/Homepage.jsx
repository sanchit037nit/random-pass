        ...
        <div className="space-y-10 p-6 sm:p-8">
          {Object.entries(groupedPasswords).map(([groupName, groupPasses]) => (
            <div key={groupName}>
              ...
              <h2 className="font-mono text-sm tracking-widest uppercase text-[#34D399] mb-4">
                {groupName} <span className="text-[#8B93A7]">({groupPasses.length})</span>
              </h2>
                  ...
                  .map((pass) => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <p>
                          <span className="font-mono text-xs uppercase tracking-widest text-[#8B93A7]">Name </span>
                          {pass.name}
                        </p>

                        <p className="flex items-center gap-2">
                          <span className="font-mono text-xs uppercase tracking-widest text-[#8B93A7]">Password </span>
