        ...
        <div className="flex justify-center items-start min-h-screen pt-24 pb-16 px-4">
          <div className="w-full max-w-6xl space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div
                className="bg-[#111827]/70 backdrop-blur-xl border border-[#1F2937] rounded-2xl p-6 shadow-lg
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-mono text-xs tracking-widest uppercase text-[#8B93A7]">
                    Total passwords
                  </h2>
                </div>
              ...
              {stats.recentPasswords.length > 0 ? (
                <div className="space-y-3">
                  {stats.recentPasswords.map((pass) => (
                    ...
                    >
                      <div>
                        <p className="font-medium text-[#E6E8EC]">
                          {pass.name}
                        </p>
