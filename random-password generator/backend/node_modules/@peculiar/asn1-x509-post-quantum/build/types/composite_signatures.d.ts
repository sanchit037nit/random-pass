 ...
 * ```
 */
export declare const id_alg_composite = "1.3.6.1.4.1.18227.2.1";
/**
 * ```asn
 * CompositeParams ::= SEQUENCE SIZE (2..MAX) OF AlgorithmIdentifier
 * ```
 */
export declare class CompositeParams extends AsnArray<AlgorithmIdentifier> {
 ...
 * ```
 */
export declare class CompositeSignatureValue extends AsnArray<ArrayBuffer> {
